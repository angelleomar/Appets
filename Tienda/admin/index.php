...
if (!empty($_SESSION['active'])) {
    header('location: /Tienda/admin/productos.php');
} else {
    if (!empty($_POST)) {
        $alert = '';
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Tienda/assets/css/sb-admin-2.min.css">
    <link rel="shortcut icon" href="/Tienda/assets/img/favicon.ico" />
</head>
...
<body class="bg-gradient-primary">
    ...
    <script src="/Tienda/assets/js/jquery-3.6.0.min.js"></script>
    <script src="/Tienda/assets/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="/Tienda/assets/js/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="/Tienda/assets/js/sb-admin-2.min.js"></script>
